...
<body>
    ...
    <div class="container-fluid">
        ...
        <br>
        <?php
        if (isset($_SESSION["eksekusi_admin"])) {
            echo "<div class='alert alert-success alert-dismissible fade show' role='alert'>
            <strong>Data Berhasil Ditambahkan</strong>
            <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
            <span aria-hidden='true'>&times;</span>
            </button></div>";
            unset($_SESSION["eksekusi_admin"]);
        }
        ?>
        <div class="card mb-2" style="border: none; width: 100%; padding-left:20px; padding-top:20px; padding-right:20px; ">
            <div>
                <h2>DATA INPUT USER IT</h2>
                <br>
            </div>
            <div class="table-responsive mb-5">
                <table class="nowrap table table-bordered table-striped" id="example">
                    ...
                    <tbody>
                        ...
                        $no = 1;
                        $query_sql = "SELECT * FROM tb_input_user ORDER BY tanggal DESC";
                        ...
                        <tr style='text-transform: capitalize;'>
                            ...
                            <td><a href='action_admin.php?id_input=$hasil[id_input]' class='btn btn-info'>Edit</a></td>
