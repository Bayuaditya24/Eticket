       ...
       if (isset($_POST['filter'])) {
        ...
        $tanggal_akhir = mysqli_real_escape_string($conection, $_POST['tanggal_akhir']);
            ...
            <div class="table-responsive mb-5">
                <table class="table table-bordered" id="example">
                    ...
                    <tbody>
                        ...
                        if (isset($_POST['filter'])) {
                            $tanggal_awal = mysqli_real_escape_string($conection, $_POST['tanggal_awal']);
                            $tanggal_akhir = mysqli_real_escape_string($conection, $_POST['tanggal_akhir']);
                            $data = mysqli_query($conection, "SELECT * FROM tb_input_user WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
                           
                        } else {
                            $data = mysqli_query($conection, "SELECT * FROM tb_input_user ORDER BY tanggal DESC");
                        }
                ...
                <div class="form-group">
            <a href="cetak.php?tanggal_awal=<?php echo $tanggal_awal; ?>&&tanggal_akhir=<?php echo $tanggal_akhir; ?>" target="_blank" class="btn btn-success">Cetak Laporan</a>
        </div>
            </div>
        </div>
    </div>
