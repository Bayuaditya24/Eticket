                ...
                <div class="text-center">
                    ...
                    <h4 style="font-size: 15px;">ADMIN</h4>
                        <div class="form-group">
                            <div class="mb-3 mt-4">
                                <input type="text" placeholder="Username" name="username_admin" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="mb-3">
                                <input type="password" placeholder="Password" name="password_admin" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group">
                        <a href="home_admin.php"></a>
                        <button type="log-in" name="log-in" class="btn btn-success form-control mt-2 ">Login</button>
                        </div>
                        ...
                        if (isset($_GET['pesan'])) {
                            if ($_GET['pesan']== "gagal") {
                                ...
                                <p><a href='login_admin.php'>Refresh Page</a></p>";
                            }
                        }
